    ...
    <section class="section">
        <div class="section-header">
            ...
            <div>
                ...
                <a href="<?php echo site_url('mmember/member/cart_tambah/' . $produk->idProduk); ?>" class="btn btn-primary">Buy</a>
                <a href="<?php echo site_url('mmember/member/basket/' . $produk->idProduk); ?>" class="btn btn-primary">Add to Basket</a>
            </div>
