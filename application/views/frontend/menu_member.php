<ul class="nav nav-pills flex-column">
    ...
    <li class="nav-item"><a href="<?php echo site_url('mmember/member/transaksi'); ?>" class="nav-link">Transaksi</a></li>
    ...
    <li class="nav-item"><a href="<?php echo site_url('mmember/member/wishlist'); ?>" class="nav-link">Keranjang</a></li>
